...
const Stats = () => {
  return (
    <div className="md:p-10 flex flex-row justify-between items-center w-full z-2 bg-white h-40">
        <div className=""><div className="flex flex-col justify-center items-center"><img src={imgone} alt="calender" className="h-12 md:h-20 m-2 " /> <p className="m-1">December</p></div> 
        </div>
        ...
        <div><div className="flex flex-col justify-center items-center"><img src={imgthree} alt="ticket" className="h-12 md:h-20 m-2" /> <p className="m-1">50rs per head</p></div></div>
    </div>
  )
}
